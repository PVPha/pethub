                ...
                <form>
                    <div class="search">
                        <input type="search" value="Tìm kiếm" onfocus="this.value = '';"
                            onblur="if (this.value == '') {this.value = 'Tìm kiếm';}" required="" />
                    </div>
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list" style="margin-left: 15rem">
                            <li class="active menu__item menu__item--current">
                                <a class="menu__link" href="/">Trang chủ <span
                                        class="sr-only">(current)</span></a>
                            </li>
                            <li class="dropdown menu__item">
                                <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">Chó <span
                                        class="caret"></span></a>
                            ...
                            <li class="dropdown menu__item">
                                <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">Mèo <span
                                        class="caret"></span></a>
                                {{-- <ul class="dropdown-menu multi-column columns-3">
                                    <div class="row">
                                        <div class="col-sm-3 multi-gd-img">
                            ...
                            <li class="menu__item">
                                <a class="menu__link" href="#">Thức ăn </a>
                            </li>
                            <li class="menu__item">
                                <a class="menu__link" href="#">Đồ chơi</a>
                            </li>
                            <li class="menu__item">
                ...
                <div class="sign-grds">
                    <div class="col-md-4 sign-gd">
                        ...
                        <ul>
                            ...
                            <li><a href="mens.html">Chó</a></li>
                            <li><a href="womens.html">Mèo</a></li>
                            <li><a href="electronics.html">Thức ăn</a></li>
                            <li><a href="codes.html">Đồ chơi</a></li>
                    ...
                    <div class="col-md-4 sign-gd-two">
                        ...
                        <ul>
                            <li>
                                <i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>địa chỉ : 236b Lê Văn
                                Sĩ phường 9 quận Tân Bình <span>TP HCM.</span>
                            </li>
                            <li>
                            ...
                            <li>
                                <i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>SĐT : +841234 567 567
                            </li>
                        </ul>
                    </div>
