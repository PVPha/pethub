    ...
    <div class="single">
        <div class="container">
                    ...
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li style="list-style: none;" data-thumb="images/d2.jpg">
                                <div class="thumb-image"> <img id="img"
                                        src="{{ url('images') . '/' . $detail[0]->img }}"
            ...
            <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated"
                ...
                <h3 id="name">{{ $detail[0]->name }}</h3>
                <p style="font-size: 1.15rem">Giá:<span id="price"> {{ $detail[0]->price }} VNĐ</span></p>
                <div class="rating1">
                ...
                <div class="occasion-cart">
                    <a id="addCart" class="item_add hvr-outline-out button2">Thêm vào giỏ hàng</a>
                    <script>
                        (() => {
                        ...
                        document.getElementById("addCart").addEventListener("click", () => {
                            ...
                            let quantity = 1;
                            let data = [];
                            data.push(name, img, price, quantity);
